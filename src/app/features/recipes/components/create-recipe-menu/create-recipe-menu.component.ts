...
@Component({
  selector: 'app-create-recipe-menu',
  standalone: true,
  template: `
    <div
    ...
    >
      ...
      >
        <div class="border-b border-stone-100 p-4">
          <h2 id="create-recipe-menu-title" class="text-base font-semibold text-stone-900">
            Create recipe
          </h2>
          <p class="mt-0.5 text-sm text-stone-600">
            Add a recipe manually, by voice, or from a photo.
          </p>
        </div>
...
export class CreateRecipeMenuComponent {
  ...
  readonly options: {
  ...
  }[] = [
    {
      id: 'manual',
      title: 'Add manually',
      description: 'Fill in the recipe form step by step.',
    },
    {
      id: 'voice',
