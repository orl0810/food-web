...
export const LANDING_FAQS: readonly LandingFaq[] = [
  { question: 'Is PantryFlow a calorie tracker?', answer: 'No. PantryFlow is built around meal planning, ingredients, prepared portions, and a more manageable weekly cooking routine.' },
