          ...
          <li class="flex items-start gap-3 py-3 first:pt-0 last:pb-0">
            ...
            <div class="min-w-0 flex-1">
              ...
              @if (canChangeRecipe(item)) {
                <div
                  class="mt-3 flex flex-col gap-2 rounded-lg border border-brand-100 bg-brand-50/40 px-3 py-2.5 sm:flex-row sm:items-center sm:justify-between"
                >
                  <p class="text-xs text-stone-600">
                    Changed your mind? Pick a different recipe for this meal.
                  </p>
                  <button
                    type="button"
                    class="inline-flex shrink-0 items-center justify-center gap-1.5 rounded-lg border border-brand-200 bg-white px-3 py-1.5 text-xs font-semibold text-brand-700 shadow-sm transition-colors hover:border-brand-300 hover:bg-brand-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-500"
