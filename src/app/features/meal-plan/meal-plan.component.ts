    ...
    <div class="page">
      ...
      @if (showAutogenerateDialog()) {
        <app-meal-plan-autogenerate-dialog
          ...
          (generated)="onMealsAutogenerated()"
        />
      }
        ...
        <div>
          <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex flex-wrap items-center gap-2">
              ...
              <!-- Previous top-level Add food action retained intentionally; manual slot actions remain available.
              <button type="button" class="btn-primary-sm" (click)="showAddFoodMenu.set(true)">Add food</button>
              -->
              <button type="button" class="btn-primary-sm" [disabled]="!isCurrentWeek()"
                [attr.title]="isCurrentWeek() ? null : 'Autogeneration is available for the current week only.'"
...
export class MealPlanComponent implements OnInit {
  ...
  async onMealsAutogenerated(): Promise<void> {
    await this.toCookService.refresh();
  }
